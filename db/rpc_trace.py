...
def register():
    apiproxy_stub_map.apiproxy.GetPreCallHooks().Append('djangodebug', pre_call_hook)
    #apiproxy_stub_map.apiproxy.GetPostCallHooks().Append('djangodebug', post_call_hook)
